...
export default {
  ...
  methods: {
    ...
    //获得所有市
    getAllProvince(dicCode) {
      hospitalApi.findByDictCode(dicCode).then((res) => {
    ...
    provinceChanged() {
      ...
      hospitalApi.findByParentId(this.searchObj.provinceCode).then((res) => {
